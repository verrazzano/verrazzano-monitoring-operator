...
func verifyElasticSearch(t *testing.T, vmo *vmcontrollerv1.VerrazzanoMonitoringInstance,
	...
	assert.Equal(constants.VerrazzanoKubeObjectName, sts.Spec.Template.Spec.Containers[0].Env[4].ValueFrom.SecretKeyRef.Name, "Incorrect Env[4] Secret name")
	...
	assert.Equal(constants.VerrazzanoKubeObjectName, sts.Spec.Template.Spec.Containers[0].Env[5].ValueFrom.SecretKeyRef.Name, "Incorrect Env[5] Secret name")
