...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SMTPInfo) DeepCopyInto(out *SMTPInfo) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SMTPInfo.
func (in *SMTPInfo) DeepCopy() *SMTPInfo {
	if in == nil {
		return nil
	}
	out := new(SMTPInfo)
