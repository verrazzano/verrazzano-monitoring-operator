...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstallPlugins) DeepCopyInto(out *InstallPlugins) {
	*out = *in
	if in.Plugins != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstallPlugins.
func (in *InstallPlugins) DeepCopy() *InstallPlugins {
	if in == nil {
		return nil
	}
	out := new(InstallPlugins)
	in.DeepCopyInto(out)
	return out
}
