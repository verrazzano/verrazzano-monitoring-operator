...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IndexManagement) DeepCopyInto(out *IndexManagement) {
	*out = *in
	if in.Enabled != nil {
	...
	if in.MaxSystemIndexAge != nil {
		in, out := &in.MaxSystemIndexAge, &out.MaxSystemIndexAge
		*out = new(string)
		**out = **in
	}
	if in.MaxApplicationIndexAge != nil {
		in, out := &in.MaxApplicationIndexAge, &out.MaxApplicationIndexAge
		*out = new(string)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IndexManagement.
func (in *IndexManagement) DeepCopy() *IndexManagement {
	if in == nil {
		return nil
	}
	out := new(IndexManagement)
