...
// IstioCertsOutputPathEnvValue istio certs output path setting value
const IstioCertsOutputPathEnvValue = `{"proxyMetadata":{ "OUTPUT_CERTS": "/etc/istio-output-certs"}}`
