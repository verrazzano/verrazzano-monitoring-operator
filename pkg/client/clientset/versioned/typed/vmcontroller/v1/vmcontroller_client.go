...
import (
	...
	"github.com/verrazzano/verrazzano-monitoring-operator/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type VerrazzanoV1Interface interface {
	RESTClient() rest.Interface
	VerrazzanoMonitoringInstancesGetter
}
...
func (c *VerrazzanoV1Client) VerrazzanoMonitoringInstances(namespace string) VerrazzanoMonitoringInstanceInterface {
	return newVerrazzanoMonitoringInstances(c, namespace)
}
...
// NewForConfigAndClient creates a new VerrazzanoV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*VerrazzanoV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &VerrazzanoV1Client{client}, nil
}

// NewForConfigOrDie creates a new VerrazzanoV1Client for the given config and
