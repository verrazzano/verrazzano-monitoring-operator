...
// Returns, based on the given framework object, whether or not to run the before phase.
func RunBeforePhase(f *framework.Framework) bool {
	return framework.Before == f.Phase || f.Phase == ""
}

// Returns, based on the given framework object, whether or not to run the after phase.
func RunAfterPhase(f *framework.Framework) bool {
	return framework.After == f.Phase || f.Phase == ""
}

// Returns, based on the given framework object, whether or not to skip teardown
