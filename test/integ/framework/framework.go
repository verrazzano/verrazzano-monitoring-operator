...
func Setup() error {
	...
	skipTeardown := flag.Bool("skipteardown", false, "Skips tearing down VMI instances created by the tests")
	...
	s := schema.GroupVersion{Group: constants.VMIGroup, Version: constants.VMIVersion}
	cfg.GroupVersion = &s
	cfg.APIPath = "/apis"
