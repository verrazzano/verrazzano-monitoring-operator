...
push-tag-eswait:
	...
	docker tag ${DOCKER_IMAGE_FULLNAME_ESWAIT}:${DOCKER_IMAGE_TAG} ${DOCKER_IMAGE_FULLNAME_ESWAIT}:${PUBLISH_IMAGE_TAG}
	docker push ${DOCKER_IMAGE_FULLNAME_ESWAIT}:${PUBLISH_IMAGE_TAG}
