...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME_OPERATOR = " ${env.BRANCH_NAME ==~ /^release-.*/ || env.BRANCH_NAME == 'master' ? env.DOCKER_PUBLISH_IMAGE_NAME_OPERATOR : env.DOCKER_CI_IMAGE_NAME_OPERATOR}".trim()
